...
(function() query{
                                                          //Self executing function Main Function() run
	...
	var validate==function(query){                                         // Validation variable declared
		...
		if(query.length < 3) {                                             //Checks o validate character length
            ...
            return;
                                                                 ...
                                                                 //Will alert user the return of the search from database
    ...
    var html = ''+	                       //noinspection UnnecessaryLocalVariableJS
                                                                    //browser variable declared
